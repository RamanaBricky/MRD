    ...
    var mrdDataStruct:[Int:[Int:[MRDData]]]{
        return [1:[1:[MRDData(1,"Defrost", .hours, 12, .days, 3, false), MRDData(2, "S&C", .hours, 0, .hours, 6, false), MRDData(3, "BBQ", .hours, 0, .hours, 6, false)],
                ...
                2:[1:[MRDData(1," ", .days, 1, .days, 3)],
                   2:[MRDData(1,"Unopen", .hours, 0, .useByDate, 0), MRDData(1,"Open", .hours, 0, .days, 2)],
                ...
                5:[1:[MRDData(1," ", .hours, 1, .days, 3)],
                   2:[MRDData(1,"Unopen", .hours, 0, .useByDate, 0, false), MRDData(1,"Open", .hours, 0, .days, 13)],
                   3:[MRDData(1,"Unopen", .hours, 0, .useByDate, 0, false), MRDData(1,"Open", .hours, 0, .days, 27)]],
